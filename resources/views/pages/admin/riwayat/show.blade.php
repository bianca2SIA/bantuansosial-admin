                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="text-muted">Tahap Penyaluran</label>
                                        <p class="fw-bold">
                                            Tahap {{ $riwayat->tahap_ke }}
                                        </p>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="text-muted small mb-1">Bukti Penyaluran Bantuan</label>
                                        ...
                                        @if ($riwayat->media->count())
                                            <div class="table-responsive">
                                                <table class="table table-sm table-bordered align-middle text-center mb-0">
                                                    ...
                                                    <tbody class="small">
                                                        @foreach ($riwayat->media as $i => $file)
                                                            <tr>
                                                                <td>{{ $i + 1 }}</td>

                                                                <td>
                                                                    @if (in_array(pathinfo($file->file_name, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'webp']))
                                                                        <img src="{{ asset('storage/uploads/riwayat_bantuan/' . $file->file_name) }}"
                                                                ...
                                                                <td class="text-start py-1">
                                                                    ...
                                                                    <small class="text-muted">
                                                                        <a href="{{ asset('storage/uploads/riwayat_bantuan/' . $file->file_name) }}"
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('riwayat.media.download', $file->media_id) }}"
   ...
   if(confirm('Yakin hapus file ini?')){
       document.getElementById('del-{{ $file->media_id }}').submit();
                                                                    ...
                                                                    <form id="del-{{ $file->media_id }}"
                                                                        action="{{ route('riwayat.media.delete', $file->media_id) }}"
                                    ...
                                    <form method="POST" action="{{ route('riwayat.media.upload', $riwayat->riwayat_id) }}"
                                        enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group">
                                            <label class="text-muted">Upload Bukti Penyaluran</label>
