                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="anggaran" class="form-control"
                                                value="{{ old('anggaran') }}" placeholder="Masukkan anggaran" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 d-flex flex-column">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" class="form-control" rows="5" placeholder="Tuliskan deskripsi program" required>{{ old('deskripsi') }}</textarea>
                                        </div>
