...
<head>
    ...
    {{-- 🎨 CSS tambahan halaman login & success --}}
    <style>
        ...
        body {
            ...
            align-items: center;
            background:
                linear-gradient(rgba(245, 240, 250, 0.4), rgba(215, 195, 247, 0.5)),
        ...
        /* Hover efek lembut */
        .card-container:hover, .success-container:hover {
