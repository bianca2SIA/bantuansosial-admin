        ...
        new Chart(ctx, {
            ...
            data: {
               labels: [
                ...
                datasets: [{
                  data: [
                    window.statusPenyaluran.disalurkan,
                    window.statusPenyaluran.dalamProses,
                    window.statusPenyaluran.belumDisalurkan
                ],
